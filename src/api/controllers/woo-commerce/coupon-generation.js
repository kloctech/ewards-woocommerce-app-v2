...
export default async (req, res) => {
  ...
  try {
    const member = new CreateCouponService(consumerKey, consumerSecret, storeUrl, body.minimum_amount, body.email_restrictions, body.bill_amount, body.coupon_details, body.points, body.mobile_number, body.cart_id);
