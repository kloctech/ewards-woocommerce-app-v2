...
const { MONGODB_URI, PORT, JWT_SECRET_KEY, REFRESH_TOKEN_SECRET_KEY, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_REGION, BUCKET_NAME, PRODUCTION_URL, EWARDS_ADD_MEMBER_API_URL, LOYALTY_INFO_REQUEST_API_URL, LOYALTY_INFO_VERIFY_API_URL, COUPON_REDEMPTION_API_URL } = process.env;
...
export const couponRedemptionApiUrl = COUPON_REDEMPTION_API_URL;
