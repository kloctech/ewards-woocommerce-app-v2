...
const { MONGODB_URI, PORT, JWT_SECRET_KEY, REFRESH_TOKEN_SECRET_KEY, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_REGION, BUCKET_NAME, PRODUCTION_URL, EWARDS_API_URL, POINT_REDEEM_REQUEST, CREATE_WOOCOMMERCE_CODE, EWARDS_ADD_MEMBER_API_URL, LOYALTY_INFO_REQUEST_API_URL, LOYALTY_INFO_VERIFY_API_URL, COUPON_REDEEM_REQUEST, BILL_SETTLEMENT_REQUEST, BILL_CANCEL_REQUEST, FRONTEND_APP_URL } = process.env;
...
export const createWoocommerceCode = CREATE_WOOCOMMERCE_CODE;
...
export const couponRedeemRequest = COUPON_REDEEM_REQUEST;
export const billSettlementRequest = BILL_SETTLEMENT_REQUEST;
export const billCancelRequest = BILL_CANCEL_REQUEST;
export const frontendUrl = FRONTEND_APP_URL;
